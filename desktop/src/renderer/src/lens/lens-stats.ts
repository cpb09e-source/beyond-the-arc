...
export const TEAM_LENS_FOR: Record<string, { stat: string; adjusted?: boolean }> = {
  ...
  orb: { stat: "orbr" },
  fg3: { stat: "fg3_pct" },
  // The Team Explorer by the site's own keys, as its views name them
  a_ortg: { stat: "ortg", adjusted: true },
  a_drtg: { stat: "drtg", adjusted: true },
  a_net: { stat: "net", adjusted: true },
  adjt: { stat: "pace", adjusted: true },
  cbb_pace: { stat: "pace" },
  cbb_efg: { stat: "efg" },
  cbb_efg_def: { stat: "efgd" },
  cbb_tov: { stat: "tovr" },
  cbb_orb: { stat: "orbr" },
  cbb_fg3: { stat: "fg3_pct" },
  cbb_ft: { stat: "ft_pct" },
  cbb_ts: { stat: "ts" },
  cbb_ftarate: { stat: "ftr" },
  cbb_ortg: { stat: "ortg" },
  cbb_drtg: { stat: "drtg" },
