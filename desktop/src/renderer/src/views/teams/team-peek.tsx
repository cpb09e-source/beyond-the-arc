...
/**
 * What a team Peek says: who they are, what they are best and worst at
 * nationally, and whether they sit inside the contender zone.
 *
 ...
 */
export function TeamPeekBody({ season, team }: { season: Season; team: Team }) {
      ...
      <header className="flex items-start gap-3 px-4 pb-3 pt-3.5">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-baseline justify-between gap-2">
            <h2 className="truncate text-[16px] font-semibold leading-tight tracking-[-0.01em] text-ink">{team.name}</h2>
            {team.btaRank != null && (
