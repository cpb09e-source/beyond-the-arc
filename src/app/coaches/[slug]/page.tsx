  ...
  return (
    <>
      ...
      <section className="border-b border-hairline relative">
        ...
        <div className="relative mx-auto max-w-[var(--page-max)] px-6 lg:px-10 pt-12 pb-5 lg:pb-12">
      ...
      {marchGames.length > 0 && (
        <section className="mx-auto max-w-[var(--page-max)] px-6 lg:px-10 pt-4 lg:pt-8">
          <ScheduleTicker
            games={marchGames}
      ...
      {/* STAT TILES */}
      <section className="mx-auto max-w-[var(--page-max)] px-6 lg:px-10 pt-8">
      ...
      <section className="mx-auto max-w-[var(--page-max)] px-6 lg:px-10 mt-6 pb-12">
