  ...
  return (
    <>
      ...
      <section className="border-b border-hairline relative">
        ...
        <div className="relative mx-auto max-w-[var(--page-narrow)] px-6 lg:px-10 pt-12 pb-5 lg:pb-12">
                ...
                {profile.is_active && profile.current_team ? (
                  <span className="inline-flex items-center gap-2 text-ink-soft">
                    ...
                    <Link href={`/teams/${teamSlug(profile.current_team)}/`} className="inline-flex items-center gap-2 font-medium text-ink hover:text-coral transition-colors">
                      ...
                      <TeamName name={profile.current_team} />
                    </Link>
                  </span>
                ) : (
                  <span className="text-ink-soft">
                    Last coached at <span className="font-medium text-ink">{profile.current_team ? <TeamName name={profile.current_team} /> : "—"}</span>
      ...
      {marchGames.length > 0 && (
        <section className="mx-auto max-w-[var(--page-narrow)] px-6 lg:px-10 pt-4 lg:pt-8">
          <ScheduleTicker
            games={marchGames}
      ...
      {/* STAT TILES */}
      <section className="mx-auto max-w-[var(--page-narrow)] px-6 lg:px-10 pt-8">
      ...
      {profile.schools.length > 0 && (
        <section className="mx-auto max-w-[var(--page-narrow)] px-6 lg:px-10 mt-6">
      ...
      <section className="mx-auto max-w-[var(--page-narrow)] px-6 lg:px-10 mt-8">
      ...
      <section className="mx-auto max-w-[var(--page-narrow)] px-6 lg:px-10 mt-6 pb-12">
