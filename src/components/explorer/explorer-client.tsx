...
import { TABLE_VIEWS, viewByKey, viewGroups } from "@/lib/team-views";
import { RATING_COLS, exportColsForView, fmtColValue, pinnedColumn, type TeamCol } from "@/lib/team-explorer-columns";
      ...
      <div id="teams-table" className="bg-card border border-ink/10 border-x-0 lg:border-x rounded-none lg:rounded-xl shadow-md overflow-hidden ring-0 lg:ring-1 ring-ink/5 mt-6 max-md:mt-2 scroll-mt-6 -mx-6 lg:mx-0">
        ...
        <div className={cn(
          ...
          <div className="flex flex-wrap items-center gap-x-2.5 gap-y-2 min-w-0">
            ...
            <div className="relative hidden lg:block">
              ...
              <input
                ...
                className="h-8 w-56 pl-8 pr-8 rounded-md border border-ink/15 bg-card text-ink text-xs placeholder:text-ink-muted shadow-sm hover:border-ink/25 focus:outline-none focus:ring-2 focus:ring-coral/40 focus:border-coral/40 transition-colors"
              />
              {tableSearch && (
                <button
                  type="button"
            ...
            <label className="inline-flex items-center gap-1.5 min-w-0">
              <span className="hidden sm:inline text-xs uppercase tracking-widest text-ink-muted font-medium whitespace-nowrap">
                View
              </span>
              <Select
          ...
          <div className="flex items-center gap-2 lg:gap-3 w-auto justify-end min-w-0">
            ...
            <span className="hidden sm:inline text-xs uppercase tracking-widest text-ink-muted font-medium">Show</span>
            <Select
