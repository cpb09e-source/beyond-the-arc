  ...
  return (
    <span ref={wrapperRef} className="relative inline-flex items-center">
      <button
        ...
        className="inline-flex items-center gap-1.5 cursor-pointer rounded-md border border-current/30 hover:border-current/60 bg-current/[0.06] hover:bg-current/[0.12] px-2 py-1.5 sm:py-0.5 transition-colors"
      >
