  ...
  return (
    <>
      <div>
        ...
        <div
          ref={scrollerRef}
          // p-1 -m-1 IS NOT SPACING, it is headroom for the tournament tiles.
          ...
          //
          // HORIZONTAL FOR THE SAME REASON, added after the vertical fix missed
          // half the problem. The LAST tile of a season — the tournament exit,
    ...
    >
      ...
      <span
        className={cn(
          ...
          // STILL A TINT UNDER A COLORED LETTER. Swapping this for a solid
          ...
          // tile that is paper, so a 22% tint of the result color reads as a
          // chip. On a TOURNAMENT tile the tile itself is already washed that
          // same color, and tinting the chip the same hue again stacks green
          ...
          // color there instead lifts the letter to 3.19, the best contrast
          // this chip gets in either state, and keeps the pill shape that
          // makes the March stretch scannable. The letter's color never
