              ...
              <li key={section.group ?? "all"}>
                ...
                <button
                  ...
                  className={cn(
                     ...
                     */
                    /**
                     * ONE SIZE FOR EVERY PANEL, whatever the control looks
                     * like. The list used to follow `compact`, so a narrow
                     * control opened a small list and a wide one opened a
                     * larger list — on the explorer that put two panels a few
                     * inches apart at different sizes. `compact` still sizes
                     * the CONTROL, which is what it was for: a short value in
